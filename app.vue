...
useHead({
    title: `${conversationTitle.value} - AI.DEV`,
    meta: [
        {
            name: 'viewport',
...
<template>
    <a
        href="https://github.com/Pari-Malam/AI.DEV"
        target="_blank"
        id="fork-corner"
    ...
    <div class="flex flex-row min-h-screen text-slate-300">
        ...
        >
            <header class="px-3 py-6 text-center bg-purple-500/[15%] shadow relative">
                ...
                <!-- Title -->
                <h1 class="text-2xl font-bold text-white/80 drop-shadow-md">AI.<span class="font-light">DEV</span></h1>
            </header>
            ...
            <footer class="px-3 pb-6 text-center">
                <span class="text-xs font-light text-slate-400">
                    powered by
                    <a href="https://github.com/Pari-Malam/AI.DEV" target="_blank">
                        https://github.com/Pari-Malam/AI.DEV
                    </a>
                </span>
            </footer>
        </div>
